                ...
                <form className='space-y-4 md:space-y-6' action='#'>
                  <div>
                    ...
                    <input
                      ...
                      name='email'
                      id='email'
                      className='bg-transparent outline-none border focus:ring-1 border-gray-500 border-opacity-30 text-gray-900 placeholder:text-gray-700 sm:text-sm rounded-lg focus:ring-gray-250 focus:border-gray-250 block w-full p-2.5'
                  ...
                  <Link to={'/'}>
                    <button
                      type='button'
                      className='w-full text-white bg-gray-250 hover:bg-gray-150 focus:ring-1 focus:outline-none focus:ring-gray-250 font-semibold rounded-lg text-sm px-5 py-2.5 text-center'
                    >
                      Sign in
                    </button>
                  </Link>
